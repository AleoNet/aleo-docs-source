...
The Leo compiler rewrites if-else statements in offchain code into a sequence of ternary expressions.
...
[Libraries](./project_layout/libraries.mdx) are the right tool for sharing reusable code across programs. The following recommendations apply when authoring or consuming them.

#### 1. Extract Shared Logic into a Library
...
#### 3. Prefer Library Functions over Duplicating Logic
...
#### 4. Use Submodules for Large Libraries
