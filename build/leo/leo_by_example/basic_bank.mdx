...
You'll see that the output contains a new private record belonging to the user with 50 credits, and finalization data indicating code to be run onchain and its associated inputs.
...
You'll see here the withdrawal function creates a new private record for the user containing all 266 withdrawn tokens, and then outputs finalization data which will be run onchain.
