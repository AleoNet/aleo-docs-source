...
### SealanceMerkleTree {#new_SealanceMerkleTree_new}
...
| __maxTreeDepth__ | `number` | *Optional. Maximum depth of the Merkle tree (default: 16)* |
...
const leaves = sealance.generateLeaves(blockedAddresses, 16);
