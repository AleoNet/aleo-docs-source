...
context of Aleo, this process starts by generating a private key. From this private key, several keys can be derived that enable a user
to interact with Aleo programs:
...
```typescript
import { Account, PrivateKey } from '@provablehq/sdk/testnet.js';
