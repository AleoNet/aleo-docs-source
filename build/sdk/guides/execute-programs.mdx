...
Similar to the [Deploying Programs](./deploy-programs.mdx) guide, you'll need to initialize some fundamental objects if you haven't already done so:
...
```typescript
import { Account, AleoKeyProvider, AleoNetworkClient, ProgramManager, ProvingKey, VerifyingKey } from '@provablehq/sdk/testnet.js';
