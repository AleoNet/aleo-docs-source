...
From the perspective of the caller of the API, this is as simple as executing a normal Aleo function. For more information on how to do this with the SDK, check out the [Executing Programs](./execute-programs.mdx) guide or the [Transferring Credits](./transfer-credits.mdx) guide.
...
If you've read the [Transferring Credits](./transfer-credits.mdx) guide, the following should look familiar to you:
```typescript
// USER 1
