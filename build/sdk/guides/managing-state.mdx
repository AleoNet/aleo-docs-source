...
From the perspective of the caller of the API, this is as simple as executing a normal Aleo function. For more information on how to do this with the SDK, check out the [Executing Programs](./execute-programs.mdx) guide or the [Transferring Credits](./transfers/transfer-credits.mdx) guide.
...
representing a user.  Check out the [Public & Private State](/learn/core-concepts/public-and-private-state) page for more information.
...
```typescript
import { Account, AleoNetworkClient, AleoKeyProvider, NetworkRecordProvider, ProgramManager } from '@provablehq/sdk/testnet.js';
...
```typescript
import { Account, RecordCiphertext, RecordPlaintext } from '@provablehq/sdk/testnet.js';
...
If you've read the [Transferring Credits](./transfers/transfer-credits.mdx) guide, the following should look familiar to you:
```typescript
// USER 1
...
```typescript
// USER 2
import { Account, ProgramManager, AleoKeyProvider, NetworkRecordProvider, AleoNetworkClient, RecordCiphertext } from '@provablehq/sdk/testnet.js';
